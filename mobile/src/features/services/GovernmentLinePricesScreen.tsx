  ...
  return (
    <Screen scroll refreshing={pricesQuery.isRefetching} onRefresh={pricesQuery.refetch}>
      <RedGradientHero style={styles.hero}>
        <Text style={styles.kicker}>Гослиния</Text>
        <Text style={styles.heroTitle}>Стоимость услуг по направлениям</Text>
        <Text style={styles.heroText}>
          Выберите направление подготовки. Все цены указаны в долларах США за услуги сопровождения.
        </Text>
      </RedGradientHero>
