...
export const gradients = {
  premiumHero: [palette.brandRed, '#B71D17', palette.brandRedDark] as const,
  blue: [palette.brandBlue, '#155C91'] as const,
  warm: [palette.brandRed, palette.brandRedDark] as const,
  mint: [palette.mintGreen, '#34D399'] as const,
  surface: [palette.softWarm, palette.softRedSurface] as const,
};
